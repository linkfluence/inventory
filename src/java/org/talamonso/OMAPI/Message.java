...
public abstract class Message {
	 ...
	 */
	private LinkedHashMap<String,byte[]> msg = new LinkedHashMap<String,byte[]>();
	...
	private LinkedHashMap<String,byte[]> upd_obj = new LinkedHashMap<String,byte[]>();
	 ...
	 */
	protected LinkedHashMap<String,byte[]> obj = new LinkedHashMap<String,byte[]>();
	...
	protected byte[] sendMessage(int action) throws OmapiException {
		...
		case REFRESH: {
			...
			this.msg = new LinkedHashMap<String,byte[]>();
			this.obj = new LinkedHashMap<String,byte[]>();
		}
			// break for REFRESH!
			break;
		case CREATE: {
